          ...
          <div className="col-12 col-xl-auto">
            <div className="d-flex align-items-center justify-content-center justify-content-xl-end gap-3 header-social-wrap">
              ...
              <div className="d-flex gap-2 social-list">
                ...
                <a href="#" className="social-link">
                  <img src="/IMG/ins.png" alt="Instagram" className="social-icon" />
                </a>
                <a href="#" className="social-link">
                  <img src="/IMG/tt.png" alt="TikTok" className="social-icon" />
                </a>
                <a href="#" className="social-link">
                  <img src="/IMG/ytb.png" alt="YouTube" className="social-icon" />
                </a>
              </div>
            </div>
          </div>
        ...
        <nav className="navbar navbar-expand-xl main-menu-bar px-3 px-lg-4 py-2 position-relative">
          ...
          <div className={`collapse navbar-collapse${navExpanded ? " show" : ""}`} id="siteHeaderNav">
            <ul className="navbar-nav header-menu-list align-items-xl-center me-auto mb-0">
                            ...
                            <div className="d-flex align-items-center mb-3">
                              {group.image && (
                                <img
                                  src={group.image}
                                  alt=""
                                  className="mega-menu-group-image"
                                />
                              )}
                            ...
                            <ul className="list-unstyled ps-2 mb-0 mega-menu-list">
                              {group.items.map((item) => (
                                <li key={`${group.title}-${item.name}`} className="mb-2">
                                  ...
                                  >
                                    {item.name}
                                    {item.isSale && <span className="mega-item-sale">SALE</span>}
                                  </Link>
                                </li>
                              ))}
                            </ul>
              ...
              <li className="nav-item">
                <NavLink to="/" end className="nav-link menu-link" onClick={() => setNavExpanded(false)}>
                  TRANG CHỦ
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/about" className="nav-link menu-link" onClick={() => setNavExpanded(false)}>
                  VỀ CHÚNG TÔI
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink to="/san-pham" className="nav-link menu-link" onClick={() => setNavExpanded(false)}>
                  BỘ SƯU TẬP
                </NavLink>
              </li>
              <li className="nav-item">
