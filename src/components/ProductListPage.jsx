        ...
        <div className="container-fluid" style={{ marginTop: 24, padding: "0 50px" }}>
            <div className="d-flex align-items-end justify-content-between flex-wrap gap-3">
                ...
                <div style={{ minWidth: 220 }}>
                    <label style={{ fontWeight: 600, display: "block", marginBottom: 6 }}>Danh mục</label>
                    <select
            ...
            {/* Pagination */}
            <div className="d-flex justify-content-center align-items-center gap-2" style={{ marginTop: 18 }}>
                <button
