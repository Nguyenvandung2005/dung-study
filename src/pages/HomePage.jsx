...
function HeroBanner({ totalProducts, productCategoryCount, hotVouchers }) {//Hàm thực hiện phần banner
...
export default function HomePage({ query = "" }) {
  ...
  }, [products]); //Sử dụng useMemo để tạo mảng 4 sản phẩm ngẫu nhiên từ mảng products
  ...
  }, [products]); //Sử dụng useMemo để tạo mảng 6 sản phẩm có khuyến mãi cao nhất từ mảng products, 
